-- WORLD LAYYOFFS DATA CLEANING
-- 1 Check for and remove duplicates.
-- 2 Standardize the data.
-- 3 Null or blank values.
-- 4 Remove unwated columns.


--   Creating a staging table and inserting data into it.
...
-- Creating a new table called layoffs_stagging2
...
-- Insering data into layoffs_stagging2 table
...
-- -------------------------------------------------------------------------------------
# 4. Remove unwated columns.nted column
ALTER TABLE layoffs_staging2
DROP COLUMN row_num;
